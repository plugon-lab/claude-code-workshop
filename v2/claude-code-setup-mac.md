...
{% hint style="warning" %}
⚠️ **"손상되었거나 열 수 없습니다" 오류가 나면?**  
`시스템 설정 → 개인 정보 보호 및 보안 → 보안` 항목에서 **"그래도 열기"** 버튼을 클릭하세요.
{% endhint %}

---

## PART 2. Claude Code(CLI) 설치
...
{% hint style="success" %}
✅ **성공** — 화면 아래쪽에 입력창이 열리고 `%` 또는 `$` 기호가 깜빡이면 완료입니다.
{% endhint %}

---

### STEP 2-2. Claude Code 설치

아래 명령어를 **통째로 복사**해서 터미널에 붙여넣고 **엔터**를 누르세요.
...
{% hint style="warning" %}
⚠️ **"permission denied" 또는 "권한" 에러가 나면?**  
...
{% hint style="warning" %}
⚠️ **"command not found: claude" 에러가 나면?**  
